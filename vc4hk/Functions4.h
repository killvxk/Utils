...
double DistanceToCrosshair(fb::Vec3 MyPosition, fb::Vec3 EnemyPosition, const fb::SoldierAimingSimulation* aimer) {
	...
	fYawDifference = abs(fYawDifference - aimer->m_Pitch);
	...
	flPitchDifference = abs(flPitchDifference - aimer->m_Yaw);
