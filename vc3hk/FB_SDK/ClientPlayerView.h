...
namespace fb
{
	...
	{
	public:
        char m_subViews[0x24];//eastl::fixed_vector<ClientSubView*, 4, 2> m_subViews;			// 0x88
		ClientPlayer* m_owner;											// 0xAC
        char m_spectators[0x34];//eastl::fixed_vector<WeakPtr<ClientPlayer>, 8, 2> m_spectators;	// 0xB0
