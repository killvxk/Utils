...
namespace fb
{
	...
	public:
		...
		public:
                ...
                virtual void getDispersion(LinearTransform &, bool);   // V: 0x68
                virtual void getRecoil(LinearTransform  &, bool);             // V: 0x6C
                virtual void getCameraRecoil(LinearTransform  &);        // V: 0x70
                virtual void getLag(LinearTransform &, bool);  // V: 0x74
