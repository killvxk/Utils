...
#include "FB_SDK/ArrayTypeInfo.h"
...
namespace fb
{
	...
	class MyCurvePlotter
	{
        ...
        char m_samples[0x2c];//class eastl::deque<float,64> m_samples;                     // this+0x0
...
/*			const class fb::vehicle::Vehicle * */void* m_vehicle;                     // this+0x44
		...
		class VehicleRender :public fb::IHavokRenderObject // Inherited class at offset 0x0
		{
            ...
            char m_movingBodyText[0x10];//class eastl::vector<eastl::basic_string<char,fb::eastl_arena_allocator>,fb::eastl_arena_allocator> m_movingBodyText;                     // this+0x10
            char m_idCache[0x18];//class eastl::set<unsigned int,eastl::less<unsigned int>,fb::eastl_arena_allocator> m_idCache;                     // this+0x20
            void* m_curves;// class eastl::fixed_map<enum fb::vehicle::VehicleRender::CurveMask, fb::MyCurvePlotter *, 8, 1, eastl::less<enum fb::vehicle::VehicleRender::CurveMask>, fb::eastl_arena_allocator> m_curves;                     // this+0x38
		...
		public:
			...
			class eastl::vector<fb::vehicle::Engine *> m_engines;                     // this+0x18
			/*class eastl::vector<fb::vehicle::Wheel *,fb::eastl_arena_allocator> */void*m_wheels;                     // this+0x28
			class eastl::vector<fb::Vec3> m_wheelFrictionForces;                     // this+0x38
