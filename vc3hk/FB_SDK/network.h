...
namespace fb
{
	...
	namespace network
	{
			...
			: public Ghost		// 0x00
		{
			...
			char m_ghostInfos[0x20];//class eastl::hash_set<fb::network::GhostInfo *,eastl::hash<fb::network::GhostInfo *>,eastl::equal_to<fb::network::GhostInfo *>,fb::eastl_arena_allocator,0> m_ghostInfos;                     // 0x4
			char m_networkables[0x10];//class eastl::vector<fb::network::INetworkable *,fb::eastl_arena_allocator> m_networkables;                     // 0x24
		...
		class ICryptoKey
		{
            ...
            virtual void toString();//class eastl::basic_string<char,fb::eastl_arena_allocator> toString();	// V: 0x14
		...
		class SecureConnection
		{
            ...
            char m_reasonText[0x10];//class eastl::basic_string<char> m_reasonText;                     // this+0x4C
		...
		public:
            ...
            char pad_0x8[0x34];
            char m_connections[0x18];//class eastl::map<unsigned short,fb::network::SecureConnection *,eastl::less<unsigned short>> m_connections;                     // this+0xC
            char m_pendingConnections[0x18];//class eastl::map<fb::ISocketAddress,fb::network::SecureConnection *,eastl::less<fb::ISocketAddress>> m_pendingConnections;                     // this+0x24
            ...
            void* m_password;//class eastl::basic_string<char,fb::eastl_arena_allocator> m_password;                     // this+0x84
			class Event
			{
				...
				:public  fb::network::Secure::Event // Inherited class at offset 0x0
			{
                ...
                char hostInfo[0x10];//class eastl::basic_string<char,fb::eastl_arena_allocator> hostInfo;                     // this+0x4C
            ...
            char m_events[0xc];//class eastl::list<fb::network::Secure::Event *,fb::eastl_arena_allocator> m_events;                     // this+0x98
            char m_hostInfos[0x18];// class eastl::map<unsigned int, eastl::basic_string<char, fb::eastl_arena_allocator>, eastl::less<unsigned int>, fb::eastl_arena_allocator> m_hostInfos;                     // this+0xA4
		...
		class PacketNotification
		{
            ...
            char m_packetNotificationQueue[0xec];//class eastl::fixed_list<enum fb::network::PacketDeliveryStatus,16,1,fb::eastl_arena_allocator> m_packetNotificationQueue;                     // this+0x4
			...
			:public Secure::IHandler // Inherited class at offset 0x0
		{
			...
			/*class eastl::map<unsigned short,fb::network::Connection *,eastl::less<unsigned short>,fb::eastl_arena_allocator> */char m_connections[0x18];                     // this+0xC
		...
		{
		public:
            char m_states[0x2c];//eastl::deque<T,64> m_states;			// 0x14
		}; // 0x40
