...
namespace fb
{
	...
	public:
        ...
        char m_modifiers[0x850];// eastl::fixed_map<void const *, CameraShakeManager::CameraShakeInfo, 64, 1, eastl::less<void const *>, fb::eastl_arena_allocator> m_modifiers;                     // this+0x0
