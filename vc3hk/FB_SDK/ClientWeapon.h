...
#include "FB_SDK/Weapon.h"
#include "FB_SDK/WeaponFiringCallbackHandler.h"
#include "FB_SDK/ControllableFinder.h"
namespace fb
{
	...
	public:
        ...
        char m_fireFxHandles[0x40];//eastl::pair<UINT, FireEffectData*> m_fireFxHandles[8];					// 0x6B4
