...
namespace fb
{
	...
	public:
		...
		PAD(0x4);
        char m_callbackHandlers[0x84];//eastl::fixed_list<fb::WeaponFiringCallbacks *,8,0,fb::eastl_arena_allocator> m_callbackHandlers;                     // this+0x4
		enum Action
		{
		...
		class IterationScope
		{
			...
			eastl::vector<WeaponFiringCallbackHandler::Command> commands;                     // this+0x0
